...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 02, 2023 lúc 07:21 PM
...
(0, 'adminaa', '1', 1, 'haoad', '', '', '', '', ''),
(1, 'haoadmin', 'c4ca4238a0b923820dcc509a6f75849b', 1, 'Hào Đoàn Chính', '1701016893_48d0291b1f85e88e6c0138987048efac.jpg', 'haodoan093@gmail.com', '0346523128', 'Bắc từ Liêm , Hà Nội', 'Studied Công Nghệ Thông Tin at Trường Đại học Tài nguyên và Môi trường Hà Nội - HUNRE\r\n\r\nWent to Trường THPT Đại Cường\r\n\r\nLives in Hanoi, Vietnam\r\n\r\nSingle\r\n\r\nFollowed by 968 people'),
(3, 'admin1', 'c4ca4238a0b923820dcc509a6f75849b', 2, 'Nguyễn Ánh', '1699375429_fd2d98b5506a612231fc99a5eb00a335.jpg', 'tokuda093@gmail.com', '0348721231', 'Thanh Xuân - Hà Nội', '');
...
(91, 20, '3562', 0, '2023-10-21 20:03:08', 'momo', 9),
...
(99, 13, '260', 1, '2023-11-22 15:37:06', 'vnpay', 8),
(100, 13, '8315', 1, '2023-11-22 15:40:35', 'momo', 8),
(101, 13, '5032', 0, '2023-11-22 15:54:49', 'vnpay', 8),
(102, 13, '2830', 0, '2023-11-24 14:03:56', 'vnpay', 8),
(103, 13, '1276', 1, '2023-11-26 23:44:24', 'tienmat', 8),
(104, 13, '9447', 1, '2023-11-26 23:46:59', 'tienmat', 8),
(105, 13, '3625', 0, '2023-11-26 23:49:37', 'tienmat', 8),
(106, 13, '4620', 0, '2023-11-26 23:49:43', 'tienmat', 8),
(107, 13, '4271', 0, '2023-11-26 23:52:11', 'chuyenkhoan', 8),
(108, 13, '6253', 0, '2023-11-26 23:55:19', 'chuyenkhoan', 8),
(109, 13, '4155', 0, '2023-11-26 23:58:20', 'tienmat', 8),
(110, 13, '1932', 0, '2023-11-26 23:58:20', 'tienmat', 8),
(111, 13, '2675', 0, '2023-11-27 00:00:14', 'tienmat', 8),
(112, 13, '799', 0, '2023-11-27 00:00:27', 'tienmat', 8),
(113, 13, '1983', 0, '2023-11-27 00:03:54', 'vnpay', 8),
(114, 13, '7912', 0, '2023-11-27 00:07:34', 'momo', 8),
(115, 13, '2452', 0, '2023-11-27 00:41:18', 'tienmat', 8);
...
INSERT INTO `tbl_cart_details` (`id_cart_details`, `code_cart`, `id_sanpham`, `soluongmua`, `id_cart`) VALUES
(106, '6210', 38, 3, 100),
(107, '260', 46, 1, 100),
(117, '6253', 47, 2, 100),
(118, '4155', 50, 1, 100),
...
(13, 'Đoàn Chính Hào', 'haodoan093@gmail.com', 'Hà Nội', 'c4ca4238a0b923820dcc509a6f75849b', '0346523128', 7, 16842000),
...
INSERT INTO `tbl_danhgia` (`id`, `id_sanpham`, `id_user`, `thongtin`, `thoigian`, `sosao`) VALUES
(1, 18, 13, 'dep qua', '00', 3);
...
INSERT INTO `tbl_lienhe` (`id`, `thongtinlienhe`, `id_lh`) VALUES
...
INSERT INTO `tbl_momo` (`id_momo`, `partnercode`, `order_id`, `amount`, `order_info`, `order_type`, `trans_id`, `pay_type`, `code_cart`, `id_cart`) VALUES
(11, 'MOMOBKUN20180529', 1697881977, '2490000', 'Thanh toán qua MoMo ATM', 'momo_wallet', 2147483647, 'napas', '3550', 100),
(12, 'MOMOBKUN20180529', 1697893334, '499000', 'Thanh toán qua MoMo ATM', 'momo_wallet', 2147483647, 'napas', '3562', 100),
(13, 'MOMOBKUN20180529', 1700642380, '763000', 'Thanh toán qua MoMo ATM', 'momo_wallet', 2147483647, 'napas', '8315', 100),
(14, 'MOMOBKUN20180529', 1701018409, '3380000', 'Thanh toán qua MoMo ATM', 'momo_wallet', 2147483647, 'napas', '7912', 100);
...
(18, 'SHIRT DRESS - ĐẦM CỔ ĐỨC', 'SKU: 16B9363', 2490000, 19, '1701065865_57f87265fc2209d8681c009ca662b7ce.jpg', '<p>Ladonna Dress pha trộn giữa phong c&aacute;ch thời trang cổ điển v&agrave; hiện đại để mang đến diện mạo v&agrave;o thu vừa nhẹ nh&agrave;ng, mềm mại vừa ki&ecirc;u sa.</p>\r\n', '<p>Ladonna Dress pha trộn giữa phong c&aacute;ch thời trang cổ điển v&agrave; hiện đại để mang đến diện mạo v&agrave;o thu vừa nhẹ nh&agrave;ng, mềm mại vừa ki&ecirc;u sa.</p>\r\n', 1, 24, 0, 0, 0),
...
(30, 'QUẦN ỐNG ĐỨNG PHỐI ĐAI LỆCH', 'SKU: 22M7577', 1190000, 25, '1700931016_fb7ecb2400e5df63fb39750e5ac6dc17.jpg', '<p>Quần d&agrave;i d&aacute;ng ống đứng, độ d&agrave;i ngang mắt c&aacute; ch&acirc;n. Thiết kế eo dạng c&agrave;i với đai lệch v&agrave; m&oacute;c kim loại c&ugrave;ng m&agrave;u. Ph&iacute;a trước c&oacute; kh&oacute;a k&eacute;o. Hai b&ecirc;n c&oacute; hai t&uacute;i x&eacute;o.</p>\r\n', '<p>Quần d&agrave;i d&aacute;ng ống đứng, độ d&agrave;i ngang mắt c&aacute; ch&acirc;n. Thiết kế eo dạng c&agrave;i với đai lệch v&agrave; m&oacute;c kim loại c&ugrave;ng m&agrave;u. Ph&iacute;a trước c&oacute; kh&oacute;a k&eacute;o. Hai b&ecirc;n c&oacute; hai t&uacute;i x&eacute;o.</p>\r\n', 1, 3, 0, 2, 0),
...
(50, 'ÁO KHOÁC LEN CARO', 'SKU: 77M7802', 903000, 19, '1701017503_0b362c8ecc745ea6d8445530afeb2a5e.jpg', '<p>Th&ecirc;m v&agrave;o tủ đồ Thu - Đ&ocirc;ng của n&agrave;ng mẫu kho&aacute;c len trẻ trung, hiện đại v&agrave; phong c&aacute;ch.&nbsp;</p>\r\n\r\n<p>Thiết kế &aacute;o kho&aacute;c d&aacute;ng xu&ocirc;ng, cổ&nbsp; tr&ograve;n c&ugrave;ng tay d&agrave;i. Tay &aacute;o c&aacute;ch điệu th&ecirc;m đường ly tạo độ bồng bềnh, mang đến sự nhẹ nh&agrave;ng v&agrave; nữ t&iacute;nh.&nbsp;</p>\r\n\r\n<p>Họa tiết kẻ caro bắt mắt, h&agrave;i h&ograve;a, dễ d&agrave;ng mix với nhiều kiểu trang phục kh&aacute;c nhau.&nbsp;</p>\r\n\r\n<p>Đặc biệt, thiết kế giữ ấm v&agrave; tạo cảm gi&aacute;c thoải m&aacute;i trong thời tiết lạnh.&nbsp;</p>\r\n', '<p>Th&ecirc;m v&agrave;o tủ đồ Thu - Đ&ocirc;ng của n&agrave;ng mẫu kho&aacute;c len trẻ trung, hiện đại v&agrave; phong c&aacute;ch.&nbsp;</p>\r\n\r\n<p>Thiết kế &aacute;o kho&aacute;c d&aacute;ng xu&ocirc;ng, cổ&nbsp; tr&ograve;n c&ugrave;ng tay d&agrave;i. Tay &aacute;o c&aacute;ch điệu th&ecirc;m đường ly tạo độ bồng bềnh, mang đến sự nhẹ nh&agrave;ng v&agrave; nữ t&iacute;nh.&nbsp;</p>\r\n\r\n<p>Họa tiết kẻ caro bắt mắt, h&agrave;i h&ograve;a, dễ d&agrave;ng mix với nhiều kiểu trang phục kh&aacute;c nhau.&nbsp;</p>\r\n\r\n<p>Đặc biệt, thiết kế giữ ấm v&agrave; tạo cảm gi&aacute;c thoải m&aacute;i trong thời tiết lạnh.&nbsp;</p>\r\n', 1, 24, 0, 4, 1);
...
INSERT INTO `tbl_thongke` (`id`, `ngaydat`, `donhang`, `doanhthu`, `soluongban`, `id_admin`) VALUES
(1, '2023-05-29', 50, '18000000', 23, 0),
(2, '2023-09-27', 32, '19820000', 21, 0),
(3, '2023-08-30', 51, '6000020', 13, 0),
(4, '2023-06-21', 66, '5009002', 41, 0),
(5, '2023-07-02', 23, '1230000', 32, 0),
(6, '2023-10-04', 4, '13898000', 8, 0),
(7, '2023-10-09', 1, '2190000', 1, 0),
(8, '2023-10-17', 3, '3570000', 3, 0),
(9, '2023-10-20', 3, '17710000', 9, 0),
(10, '2023-10-21', 5, '7367000', 6, 0),
(11, '2023-11-06', 2, '9850000', 5, 0),
(12, '2023-11-22', 1, '858600', 2, 0),
(13, '2023-11-24', 1, '1192300', 2, 0),
(14, '2023-11-27', 11, '15558000', 9, 0);
...
INSERT INTO `tbl_vnpay` (`id_vnpay`, `vnp_amount`, `vnp_bankcode`, `vnp_banktranno`, `vnp_cardtype`, `vnp_orderInfo`, `vnp_paydate`, `vnp_tmncode`, `vnp_transactionno`, `code_cart`, `id_cart`) VALUES
(15, '2190000', 'NCB', 'VNP14150735', 'ATM', 'Thanh toán đơn hàng đặt tịa website AHSHOP', '20231021165028', '4L85GX41', '14150735', '982', 100),
(16, '429300', 'NCB', 'VNP14192751', 'ATM', 'Thanh toán đơn hàng đặt tịa website AHSHOP', '20231122153740', '4L85GX41', '14192751', '260', 100),
(17, '858600', 'NCB', 'VNP14192811', 'ATM', 'Thanh toán đơn hàng đặt tịa website AHSHOP', '20231122155509', '4L85GX41', '14192811', '5032', 100),
(18, '1192300', 'NCB', 'VNP14197259', 'ATM', 'Thanh toán đơn hàng đặt tịa website AHSHOP', '20231124140418', '4L85GX41', '14197259', '2830', 100),
(20, '903000', 'NCB', 'VNP14202395', 'ATM', 'Thanh toán đơn hàng đặt tịa website AHSHOP', '20231127000411', '4L85GX41', '14202395', '1983', 100);
...
--
ALTER TABLE `tbl_cart_details`
  MODIFY `id_cart_details` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=125;
...
--
ALTER TABLE `tbl_baiviet`
  ADD CONSTRAINT `dm_bv` FOREIGN KEY (`id_danhmuc`) REFERENCES `tbl_danhmucbaiviet` (`id_danhmucbaiviet`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Các ràng buộc cho bảng `tbl_cart`
--
ALTER TABLE `tbl_cart`
  ADD CONSTRAINT `donhang` FOREIGN KEY (`id_khachhang`) REFERENCES `tbl_dangky` (`id_dangky`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Các ràng buộc cho bảng `tbl_cart_details`
--
ALTER TABLE `tbl_cart_details`
  ADD CONSTRAINT `cart` FOREIGN KEY (`id_cart`) REFERENCES `tbl_cart` (`id_cart`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Các ràng buộc cho bảng `tbl_danhgia`
--
ALTER TABLE `tbl_danhgia`
  ADD CONSTRAINT `danhgia` FOREIGN KEY (`id_sanpham`) REFERENCES `tbl_sanpham` (`id_sanpham`),
  ADD CONSTRAINT `nguoidanhgia` FOREIGN KEY (`id_user`) REFERENCES `tbl_dangky` (`id_dangky`);

--
-- Các ràng buộc cho bảng `tbl_lienhe`
--
ALTER TABLE `tbl_lienhe`
  ADD CONSTRAINT `lh` FOREIGN KEY (`id_lh`) REFERENCES `tbl_admin` (`id_admin`);

--
-- Các ràng buộc cho bảng `tbl_momo`
--
ALTER TABLE `tbl_momo`
  ADD CONSTRAINT `cart_momo` FOREIGN KEY (`id_cart`) REFERENCES `tbl_cart` (`id_cart`);

--
-- Các ràng buộc cho bảng `tbl_sanpham`
--
ALTER TABLE `tbl_sanpham`
  ADD CONSTRAINT `danhmuc_to_sanpham` FOREIGN KEY (`id_danhmuc`) REFERENCES `tbl_danhmuc` (`id_danhmuc`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Các ràng buộc cho bảng `tbl_shipping`
--
ALTER TABLE `tbl_shipping`
  ADD CONSTRAINT `giaohang` FOREIGN KEY (`id_dangky`) REFERENCES `tbl_dangky` (`id_dangky`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Các ràng buộc cho bảng `tbl_thongke`
--
ALTER TABLE `tbl_thongke`
  ADD CONSTRAINT `quanly` FOREIGN KEY (`id_admin`) REFERENCES `tbl_admin` (`id_admin`);

--
-- Các ràng buộc cho bảng `tbl_vnpay`
--
ALTER TABLE `tbl_vnpay`
  ADD CONSTRAINT `cart_vnpay` FOREIGN KEY (`id_cart`) REFERENCES `tbl_cart` (`id_cart`);
COMMIT;
