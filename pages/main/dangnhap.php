...
<style>
    ...
    .login-container {
        ...
        /* Animation cho đổ bóng */
    }

    .login-container:hover {
        box-shadow: 0 0 20px rgba(0, 0, 0, 0.4);
        /* Đổ bóng tăng khi hover */
    }
    ...
    .login-table {
        ...
        /* Hiệu ứng khi di chuột vào bảng */
        margin-left: 20px;
        /* Di chuyển sang phải 20px */
    }

    .login-table:hover {
        transform: translateX(10px);
        /* Di chuyển sang phải 10px khi hover */
    ...
    .quenmk {
        display: block;
        /* Hiển thị nút "Quên mật khẩu" dưới dạng khối */
        text-align: left;
        /* Căn phải */
        margin-top: 10px;
        /* Khoảng cách giữa nút "Đăng nhập" và nút "Quên mật khẩu" */
    }
