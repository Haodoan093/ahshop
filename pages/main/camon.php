...
if (isset($_SESSION['code_cart'])) {
    ...
    if (isset($_GET['vnp_Amount'])) {
        ...
        $insert_vnpay = "INSERT INTO tbl_vnpay(vnp_amount,vnp_bankcode,vnp_banktranno,vnp_cardtype,vnp_orderinfo,vnp_paydate,vnp_tmncode,vnp_transactionno,code_cart,id_cart)
        VALUES('" . $vnp_Amount . "','" . $vnp_BankCode . "','" . $vnp_BankTranNo . "','" . $vnp_CardType . "','" . $vnp_OrderInfo . "','" . $vnp_PayDate . "','" . $vnp_TmnCode . "','" . $vnp_TransactionNo . "','" . $code_cart . "',100)";
    ...
    $insert_momo = "INSERT INTO tbl_momo(partnercode,order_id,amount,order_info,order_type,trans_id,pay_type,code_cart,id_cart)
    VALUES('" . $partnerCode . "','" . $orderId . "','" . $amount . "','" . $orderInfo . "','" . $orderType . "','" . $transId . "','" . $payType . "','" . $code_cart . "',100)";
