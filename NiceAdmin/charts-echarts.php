...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.ph" class="logo d-flex align-items-center">
...
">Home</a></li>
    ...
    <p>ECharts Examples. You can check the <a href="https://echarts.apache.org/examples/en/index.p" target="_blank">official website</a> for more examples.</p>
