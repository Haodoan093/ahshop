    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <!-- Danh muc san pham -->
          <li>
            <a href="themdmbv.php"  class="active">
            ...
            <div class="card-body">
              ...
              <form method="POST" name="formdmBV"  action="modules/quanlydanhmucbaiviet/xuly.php" onsubmit="return validateFormdmBV()">
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="tendanhmuc_baiviet" class="form-control" required>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <button type="submit" name="themdanhmucbv" class="btn btn-primary">Thêm</button>
                  </div>
                </div>
