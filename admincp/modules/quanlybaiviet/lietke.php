<?php
  ...
  ?>
       <style>
        ...
        th, td {
            padding: 10px; /* Tăng độ dày của ô hiển thị nội dung */
   ...
   <table>
        ...
        ?>
            <tr>
                ...
                <td>
                    <a class="edit-button" href="?action=quanlybaiviet&query=sua&idbaiviet=<?php echo $row['id_baiviet'] ?>">Sửa</a>
                    <a class="delete-button" href="modules\quanlybaiviet\xuly.php?idbaiviet=<?php echo $row['id_baiviet'] ?>">Xóa</a>
                </td>
            </tr>
        <?php
        }
